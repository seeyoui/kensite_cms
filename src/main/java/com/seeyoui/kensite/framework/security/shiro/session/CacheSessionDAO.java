package com.seeyoui.kensite.framework.security.shiro.session;
...
import com.seeyoui.kensite.common.web.Servlets;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
    ...
    protected void doUpdate(Session session) {
		...
		if (request != null){
			...
			if (StringConstant.TRUE.equals(updateSession) || StringConstant.FALSE.equals(updateSession)){
				return;
			}
		}
