...
public class GuestbookController extends BaseController {
	...
	public ModelAndView view(HttpSession session,
		...
		return new ModelAndView("framework/cms/guestbook/"+page, modelMap);
	}
	...
	public Object data(HttpSession session,
		...
		Guestbook guestbook = guestbookService.findOne(id);
		return guestbook;
	}
	...
	public Object listData(HttpSession session,
		...
		List<Guestbook> guestbookList = guestbookService.findList(guestbook);
		int total = guestbookService.findTotal(guestbook);
	...
	public Object listPage(HttpSession session,
		...
		List<Guestbook> guestbookList = guestbookService.findList(guestbook);
		int total = guestbookService.findTotal(guestbook);
		Page<Guestbook> page = new Page<Guestbook>(guestbook.getPage(), guestbook.getRows(), total);
		Map<String, Object> dataMap = new HashMap<String, Object>();
		dataMap.put("rows", guestbookList);
	...
	public Object listAll(HttpSession session,
			HttpServletResponse response, HttpServletRequest request,
			ModelMap modelMap, Guestbook guestbook) throws Exception {
		List<Guestbook> guestbookList = guestbookService.findAll(guestbook);
	...
	public String delete(HttpSession session,
		...
		guestbookService.delete(listId);
		RequestResponseUtil.putResponseStr(session, response, request, modelMap, StringConstant.TRUE);
		return null;
	}
	...
	public String export(HttpSession session,
		...
		List<Guestbook> guestbookList = guestbookService.findAll(guestbook);
		new ExportExcel(null, Guestbook.class).setDataList(guestbookList).write(response, fileName).dispose();
		return null;
	}
}