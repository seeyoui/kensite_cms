 ...
 * @see #setDataSource
 * @version $Id$
 * @modify 2016-5-24 来自 MyBatisSpring1.2.3版本
 */
    ...
    if (hasLength(this.typeAliasesPackage)) {
      ...
      for (String packageToScan : typeAliasPackageArray) {
		...
		try {
			...
			System.err.println("Scanned package: '" + packageToScan + "' for aliases\n"+ex);
      ...
      for (Resource mapperLocation : this.mapperLocations) {
        ...
        try {
          ...
          xmlMapperBuilder.parse();
        	...
        	System.err.println("Failed to parse mapping resource: '" + mapperLocation + "'\n" + e);
