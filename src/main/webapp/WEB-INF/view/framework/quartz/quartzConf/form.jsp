...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post">
				...
				<div class="fitem">
					...
					<label>cron表达式</label>
					<input class="easyui-textbox" id="cronExpression" name="cronExpression" data-options="tipPosition:'bottom',required:true,iconWidth: 22,icons: [{iconCls:'icon-search',handler: function(e){layerOpen();}}]"/>
				</div>
				<div class="fitem">
		...
		<pre id="layer_notice" style="display:none">
格式: [秒] [分] [小时] [日] [月] [周] [年]
