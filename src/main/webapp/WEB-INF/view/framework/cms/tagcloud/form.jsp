	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post">
				<div class="fitem">
					<ks:formTag table="CMS_TAGCLOUD" column="REMARKS"/>
				</div>
				<div class="fitem">
					<ks:formTag table="CMS_TAGCLOUD" column="SITE_ID"/>
				</div>
				<div class="fitem">
					<ks:formTag table="CMS_TAGCLOUD" column="NAME"/>
				</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				url = '${ctx}/cms/tagcloud/save';
				$('#siteId').combobox('setValue', parent.$('#sel_siteId').val());
				if(row != null) {
					$('#dataForm').form('load', row);
					url = '${ctx}/cms/tagcloud/update';
				}
			});
