	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post">
				<div class="fitem">
					<ks:formTag table="CMS_COLLECTIONS" column="REMARKS"/>
				</div>
				<div class="fitem">
					<ks:formTag table="CMS_COLLECTIONS" column="SITE_ID"/>
				</div>
				<div class="fitem">
					<ks:formTag table="CMS_COLLECTIONS" column="CATEGORY_ID"/>
				</div>
				<div class="fitem">
					<ks:formTag table="CMS_COLLECTIONS" column="BASIC_ID"/>
				</div>
				<div class="fitem">
					<ks:formTag table="CMS_COLLECTIONS" column="TYPE"/>
				</div>
				<div class="fitem">
					<ks:formTag table="CMS_COLLECTIONS" column="CATEGORY"/>
				</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				if(row != null) {
					...
					url = '${ctx}/cms/collections/update';
				}
			});
