    ...
    <script type="text/javascript">
        function formatOperate(val, row){
			...
			if(row['task.assignee'] == undefined || row['task.assignee'] == ""){
				...
				arra.push('<a href="${ctx}/actTask/form?taskId='+row['task.id']+'&taskName='+encodeURI(row['task.name'])+'&taskDefKey='+row['task.taskDefinitionKey']+'&procInsId='+row['task.processInstanceId']+'&procDefId='+row['task.processDefinitionId']+'&status='+row.status+'">【任务办理】</a>');
			};
