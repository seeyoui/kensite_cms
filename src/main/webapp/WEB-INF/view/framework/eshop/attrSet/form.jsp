	...
	<body>
			...
			<form id="dataForm" method="post" class="layui-form">
				<div class="layui-form-item">
					<div class="layui-inline">
						<ks:formTag table="ES_ATTR_SET" column="NAME" theme="layer"/>
					</div>
					<div class="layui-inline">
						<ks:formTag table="ES_ATTR_SET" column="SEQ" theme="layer"/>
					</div>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_ATTR_SET" column="TYPE" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_ATTR_SET" column="OPTON_VALUE" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_ATTR_SET" column="DEFAULT_VALUE" theme="layer"/>
				</div>
				<%-- <div class="layui-form-item">
					<ks:formTag table="ES_ATTR_SET" column="CATE_ID" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_ATTR_SET" column="SHOP_ID" theme="layer"/>
				</div> --%>
				<!-- <div class="layui-inline"> -->
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				url = '${ctx}/es/attrSet/save';
				if(row != null) {//row对象不为空可认定是修改
					loadData(row.id);
					url = '${ctx}/es/attrSet/update';
				} else {//反之则为新建
					//新建初始化字段示例
