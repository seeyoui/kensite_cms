	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post" class="layui-form">
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_SPEC" column="REMARKS" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_SPEC" column="SPEC_IMG" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_SPEC" column="SPEC_OPTION" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_SPEC" column="PRICE" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_SPEC" column="GOODS_ID" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_SPEC" column="SEQ" theme="layer"/>
				</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				url = '${ctx}/es/goodsSpec/save';
				if(row != null) {//row对象不为空可认定是修改
					loadData(row.id);
					url = '${ctx}/es/goodsSpec/update';
				} else {//反之则为新建
					//新建初始化字段示例
				}
			});
