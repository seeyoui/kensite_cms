	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post" class="layui-form">
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_ATTR" column="REMARKS" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_ATTR" column="ATTR_ID" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_ATTR" column="ATTR_NAME" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_ATTR" column="ATTR_VALUE" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_ATTR" column="GOODS_ID" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_GOODS_ATTR" column="SEQ" theme="layer"/>
				</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				url = '${ctx}/es/goodsAttr/save';
				if(row != null) {//row对象不为空可认定是修改
					loadData(row.id);
					url = '${ctx}/es/goodsAttr/update';
				} else {//反之则为新建
					//新建初始化字段示例
				}
			});
