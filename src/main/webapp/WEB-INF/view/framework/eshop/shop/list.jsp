			...
			<div style="position:absolute;top:0px;left:0px;right:0px;bottom:0px;">
				<table id="dataList" title="" class="easyui-datagrid" style="width:100%;height:100%"
					...
					<thead>
						<tr>
							...
							<ks:listTag table="ES_SHOP" column="REMARKS"/>
							<ks:listTag table="ES_SHOP" column="USER_NAME"/>
							<ks:listTag table="ES_SHOP" column="PASS_WORD"/>
							<ks:listTag table="ES_SHOP" column="NAME"/>
							<ks:listTag table="ES_SHOP" column="LOGO"/>
							<ks:listTag table="ES_SHOP" column="DESCRIBE"/>
							<ks:listTag table="ES_SHOP" column="ADDRESS"/>
							<ks:listTag table="ES_SHOP" column="CONFIG"/>
						</tr>
					</thead>
				</table>
				<div id="toolbar" class="toolbar">
						...
						<div class="toolbar-form">
							<form id="search-form" class="layui-form" action="">
								<div class="layui-form-item">
									<div class="layui-inline">
										<ks:queryTag table="ES_SHOP" column="NAME" theme="layer"/>
									</div>
								</div>
								<div id="form-other" style="display:none;">
									<div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SHOP" column="USER_NAME" theme="layer"/>
										</div>
									</div>
									<%-- <div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SHOP" column="PASS_WORD" theme="layer"/>
										</div>
									</div>
									<div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SHOP" column="LOGO" theme="layer"/>
										</div>
									</div> --%>
									<div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SHOP" column="DESCRIBE" theme="layer"/>
										</div>
									</div>
									<div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SHOP" column="ADDRESS" theme="layer"/>
										</div>
									</div>
									<%-- <div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SHOP" column="CONFIG" theme="layer"/>
										</div>
									</div> --%>
								</div>
							</form>
							<div id="form-btn" style="display:none;" class="layui-form-item">
								<div class="layui-input-block">
									<button class="layui-btn" onclick="$.shop.selectData()"><i class="layui-icon">&#xe615;</i></button>
					...
					<div class="toolbar-right">
						<button class="layui-btn layui-btn-normal" onclick="$.shop.newInfo()"><i class="layui-icon">&#xe61f;</i></button>
						<button class="layui-btn layui-btn-normal" onclick="$.shop.editInfo()"><i class="layui-icon">&#xe642;</i></button>
						<button class="layui-btn layui-btn-normal" onclick="$.shop.destroyInfo()"><i class="layui-icon">&#xe640;</i></button>
					</div>
				</div>
			</div>
			<div class="debug">
		...
		<script type="text/javascript">
			...
			$.shop = {
				...
				exportExcel : function () {
					window.open("${ctx}/es/shop/export");
				},
				layerOpen : function (url) {
					url = '${ctx}/es/shop/form';
					layer.open({
						type: 2,
						title: '商铺基本信息',
						area: ['635px', '460px'],
