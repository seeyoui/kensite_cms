	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post" class="layui-form">
				...
				<div class="layui-form-item">
					<ks:formTag table="ES_SPEC_SET" column="OPTION_VALUE" theme="layer"/>
				</div>
				<%-- <div class="layui-form-item">
					<ks:formTag table="ES_SPEC_SET" column="CATE_ID" theme="layer"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_SPEC_SET" column="SHOP_ID" theme="layer"/>
				</div> --%>
				<!-- <div class="layui-inline"> -->
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				url = '${ctx}/es/specSet/save';
				if(row != null) {//row对象不为空可认定是修改
					loadData(row.id);
					url = '${ctx}/es/specSet/update';
				} else {//反之则为新建
					//新建初始化字段示例
