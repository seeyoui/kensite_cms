	 	...
	 	<div style="position:absolute;top:0px;left:0px;right:0px;bottom:0px;">
			<div style="position:absolute;top:0px;left:0px;right:0px;bottom:0px;">
				<table id="dataList" title="" class="easyui-datagrid" style="width:100%;height:100%"
						url="${ctx}/es/specSet/list/data?cateId=${cateId}"
					...
					<thead>
						<tr>
							...
							<ks:listTag table="ES_SPEC_SET" column="REMARKS"/>
							<ks:listTag table="ES_SPEC_SET" column="NAME"/>
							<ks:listTag table="ES_SPEC_SET" column="CATE_ID"/>
							<ks:listTag table="ES_SPEC_SET" column="OPTION_VALUE"/>
							<ks:listTag table="ES_SPEC_SET" column="SEQ"/>
							<ks:listTag table="ES_SPEC_SET" column="SHOP_ID"/>
						</tr>
					</thead>
				</table>
				<div id="toolbar" class="toolbar">
						...
						<div class="toolbar-form">
							<form id="search-form" class="layui-form" action="">
								<div class="layui-form-item">
									<div class="layui-inline">
										<ks:queryTag table="ES_SPEC_SET" column="NAME" theme="layer"/>
									</div>
								</div>
								<div id="form-other" style="display:none;">
									<div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SPEC_SET" column="OPTION_VALUE" theme="layer"/>
										</div>
									</div>
									<%-- <div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SPEC_SET" column="CATE_ID" theme="layer"/>
										</div>
									</div>
									<div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SPEC_SET" column="SEQ" theme="layer"/>
										</div>
									</div>
									<div class="layui-form-item">
										<div class="layui-inline">
											<ks:queryTag table="ES_SPEC_SET" column="SHOP_ID" theme="layer"/>
										</div>
									</div> --%>
								</div>
							</form>
							<div id="form-btn" style="display:none;" class="layui-form-item">
								<div class="layui-input-block">
									<button class="layui-btn" onclick="$.specSet.selectData()"><i class="layui-icon">&#xe615;</i></button>
					...
					<div class="toolbar-right">
						<button class="layui-btn layui-btn-normal" onclick="$.specSet.newInfo()"><i class="layui-icon">&#xe61f;</i></button>
						<button class="layui-btn layui-btn-normal" onclick="$.specSet.editInfo()"><i class="layui-icon">&#xe642;</i></button>
						<button class="layui-btn layui-btn-normal" onclick="$.specSet.destroyInfo()"><i class="layui-icon">&#xe640;</i></button>
					</div>
				</div>
			</div>
			<div class="debug">
		...
		<script type="text/javascript">
			...
			$.specSet = {
				...
				exportExcel : function () {
					window.open("${ctx}/es/specSet/export");
				},
				layerOpen : function (url) {
					url = '${ctx}/es/specSet/form?cateId=${cateId}';
					layer.open({
						type: 2,
						title: '规格设置基本信息',
						area: ['635px', '240px'],
