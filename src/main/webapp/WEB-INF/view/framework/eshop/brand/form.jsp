			...
			<form id="dataForm" method="post" class="layui-form">
				<div class="layui-form-item">
					<div class="layui-inline">
						<ks:formTag table="ES_BRAND" column="NAME" theme="layer"/>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						<ks:formTag table="ES_BRAND" column="SITE_URL" theme="layer"/>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						<ks:formTag table="ES_BRAND" column="SEQ" theme="layer"/>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						<ks:formTag table="ES_BRAND" column="IS_SHOW" theme="layer"/>
					</div>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_BRAND" column="LOGO" theme="layer"/>
					...
					data-url="eshop/${currentUserName }/logo/" />
	                <img id="logoShow" src="${ctx }/upload/none.png"/>
				</div>
				<div class="layui-form-item">
					<ks:formTag table="ES_BRAND" column="DESCRBE" theme="layer"/>
				</div>
				<%-- <div class="layui-form-item">
					<ks:formTag table="ES_BRAND" column="SHOP_ID" theme="layer"/>
				</div> --%>
				<!-- <div class="layui-inline"> -->
