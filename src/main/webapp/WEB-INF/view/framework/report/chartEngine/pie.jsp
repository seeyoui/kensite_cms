...
chartOpt = {title: {show: true,text: '主标题文本',subtext: '副标题文本'},legend: {data: []},tooltip: {show: true,formatter: '{a} <br>{b} : {c} ({d}%)'},toolbox: {show: true,feature: {mark: {show: false},dataZoom: {show: false},dataView: {show: true},magicType: {show: false},restore: {show: true},saveAsImage: {show: true}}},series : []};
</c:if>
