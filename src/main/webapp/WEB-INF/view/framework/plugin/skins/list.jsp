 	...
 	<div style="position:absolute;top:0px;left:0px;right:0px;bottom:0px;">
		<div style="position:absolute;top:0px;left:0px;right:0px;bottom:0px;">
		    ...
		    <div id="toolbar">
				...
				<span class="toolbar-title">说明</span><input id="sel_name" name="sel_name" class="easyui-textbox" data-options=""/>
    ...
    <script type="text/javascript">
	    ...
	    function formatStateCol(val,row) {
			...
			if(val=="1") {
				...
				return "<a href=\"javascript:choseSkins('"+row.id+"');\">设为默认</a>";
			}
	    }
        ...
        function destroyInfo(){
            var row = $('#dataList').datagrid('getSelected');
            if(row.state == '1') {
            	layer.msg("默认皮肤不能删除！", {offset: 'rb',icon: 5,shift: 8,time: layerMsgTime});
            	return;
            }
            if (row){
