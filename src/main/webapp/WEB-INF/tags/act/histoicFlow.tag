...
<%@ include file="/WEB-INF/view/taglib/taglib.jsp"%>
...
<script type="text/javascript">
	$.get("${ctx}/actTask/histoicFlow?procInsId=${procInsId}&startAct=${startAct}&endAct=${endAct}&t="+new Date().getTime(), function(data){
