...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.emojiDialog = function() {
			...
			var dialogContent = [
				"<div class=\"" + classPrefix + "emoji-dialog-box\" style=\"width: 760px;height: 249px;margin-bottom: 8px;overflow: hidden;\">",
			...
			if (tab.html() === "") 
			{
				...
				for (var x = 0; x < 4; x++) 
                {
					...
					container += "<div class=\"" + classPrefix + "tab-box\" style=\"height: 215px;overflow: hidden;overflow-y: auto;" + display + "\"></div>";
				}
