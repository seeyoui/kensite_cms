define(function(require, exports, module) {
    ...
    module.exports = {
        ...
        createSeries: function(seriesArr) {
        	...
        	var content = '';
        	$.get('/kensite/static/tushuo/static/pie/tpl/legend.tpl').success(function(ctnt) {
        ...
        renderSeries: function() {
        	...
        	for(var i=0; i<seriesArr.length; i++) {
        		var series = seriesArr[i];
        		if(series.type == 'pie') {
        			if(series.roseType != null) {
        				$('div[data-cpt-con1="seriesTabKey'+series.zkey+'"]').find('div[data-cate="roseType"]').removeClass('cpt-chkbtn-i-active');
        				$('div[data-cpt-con1="seriesTabKey'+series.zkey+'"]').find('div[data-type="roseType.'+series.roseType+'"]').addClass('cpt-chkbtn-i-active');
        			}
        			...
        			if(series.radius != null) {
        				$('div[data-cpt-con1="seriesTabKey'+series.zkey+'"]').find('input[data-type="radius0"]').val(series.radius[0].replace('%',''));
        				$('div[data-cpt-con1="seriesTabKey'+series.zkey+'"]').find('input[data-type="radius1"]').val(series.radius[1].replace('%',''));
        			}
        			...
        			if(series.selectedMode != null) {
        				$('div[data-cpt-con1="seriesTabKey'+series.zkey+'"]').find('div[data-cate="selectedMode"]').removeClass('cpt-chkbtn-i-active');
        				$('div[data-cpt-con1="seriesTabKey'+series.zkey+'"]').find('div[data-type="selectedMode.'+series.selectedMode+'"]').addClass('cpt-chkbtn-i-active');
        			}
        		}
        	}
        },
